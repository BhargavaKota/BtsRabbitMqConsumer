...
namespace CoreCode.RabbitMQ.ServiceModel
{
    ...
    public sealed class RabbitMQBinding : Binding
    {
        ...
        private int m_basicQos;

        public static readonly long DefaultMaxMessageSize = 8192L;
        public static readonly int DefaultBasicQOS = 3;
        ...
        public override BindingElementCollection CreateBindingElements()
        {
            ...
            m_transport.BasicQOS = DefaultBasicQOS;
            if (BasicQOS != DefaultBasicQOS)
                m_transport.BasicQOS = BasicQOS;
        ...
        public int BasicQOS
        {
            get { return m_basicQos; }
            set { m_basicQos = value; }
        }
    }
}
