    ...
    public sealed class RabbitMQBindingConfigurationElement : StandardBindingElement
    {
        ...
        protected override void InitializeFrom(Binding binding)
        {
            ...
            if (rabbind != null)
            {
                ...
                this.BasicQOS = rabbind.BasicQOS;
            }
        }
        ...
        protected override void OnApplyConfiguration(Binding binding)
        {
            ...
            rabbind.BasicQOS = this.BasicQOS;
        }
        ...
        {
            get {
                string RabbitPassword = (string)base["password"];
                try
                {
                if((string)base["password"]!=ConnectionFactory.DefaultPass)
                   RabbitPassword= SSOSettingsFileReader.ReadString(((string)base["password"]), "RabbitPassword");
                }
                catch(Exception exp)
                {
                    throw new Exception("Excpetion while reading SSOSettingsFileReader", exp);
                }
        ...
        /// RabbitMQ BasicQOS.
        /// </summary>
        [ConfigurationProperty("basicQOS", DefaultValue = 3)]
        public int BasicQOS
        {
            get { return ((int)base["basicQOS"]); }
            set { base["basicQOS"] = value; }
        }
